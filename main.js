        ...
        .then(function weather(data){
            ...
            fetch("https://meta-weather.vercel.app/api/location/"+woeId+"/")
                ...
                .then(function weather(data){
                    ...
                    console.log("cityDate", cityDate,woeId);
                    fetch("https://meta-weather.vercel.app/api/location/"+woeId+"/"+cityDate+"/")
                    .then(function inputDate(data){
                    return data.json();
                    })
                    .then(function inputDate(data){
                     console.log('datainputData',data);
                     var woeId = data[0].woeid;

                     var inputDate = data.consolidated_weather;
                     var inputDate = document.querySelector("inputDate");
                     inputDateElement.textContent = "inputDate: "+ inputDate;
                     })
                })
